...
extension FootballPlayer {
    ...
    static func allFootballPlayersFetchRequest() -> NSFetchRequest<FootballPlayer> {
        /*
         Create a fetchRequest to fetch FootballPlayer entities from the dataFoot.
         Since the fetchRequest's 'predicate' property is not set to filter,
         all of the FootballPlayer entities will be fetched.
         */
        let fetchRequest = NSFetchRequest<FootballPlayer>(entityName: "FootballPlayer")
        /*
         List the fetched football players in alphabetical order with respect to name
         */
    ...
    /*
     ❎ CoreData @FetchRequest in PlayersList.swift invokes this class method
        to fetch filtered FootballPlayer entities from the dataFoot for the given search query.
        The 'static' keyword designates the func as a class method invoked by using the
        class name as FootballPlayer.filteredFootballPlayersFetchRequest() in any .swift file in your project.
     */
    static func filteredFootballPlayersFetchRequest(searchCategory: String, searchQuery: String) -> NSFetchRequest<FootballPlayer> {
        /*
         Create a fetchRequest to fetch FootballPlayer entities from the dataFoot.
         Since the fetchRequest's 'predicate' property is set to a NSPredicate condition,
         only those FootballPlayer entities satisfying the condition will be fetched.
         */
        let fetchRequest = NSFetchRequest<FootballPlayer>(entityName: "FootballPlayer")
        ...
        /*
         ...
         AND/OR logical operators, which is used to filter fetching from the dataFoot.
         */
