...
extension BaseballPlayer {
    ...
    static func allBaseballPlayersFetchRequest() -> NSFetchRequest<BaseballPlayer> {
        /*
         Create a fetchRequest to fetch BaseballPlayer entities from the database.
         Since the fetchRequest's 'predicate' property is not set to filter,
         all of the BaseballPlayer entities will be fetched.
         */
        let fetchRequest = NSFetchRequest<BaseballPlayer>(entityName: "BaseballPlayer")
        /*
         List the fetched baseball players in alphabetical order with respect to name
         */
    ...
    /*
     ❎ CoreData @FetchRequest in PlayersList.swift invokes this class method
        to fetch filtered BaseballPlayer entities from the database for the given search query.
        The 'static' keyword designates the func as a class method invoked by using the
        class name as BaseballPlayer.filteredBaseballPlayersFetchRequest() in any .swift file in your project.
     */
    static func filteredBaseballPlayersFetchRequest(searchCategory: String, searchQuery: String) -> NSFetchRequest<BaseballPlayer> {
        /*
         Create a fetchRequest to fetch BaseballPlayer entities from the database.
         Since the fetchRequest's 'predicate' property is set to a NSPredicate condition,
         only those BaseballPlayer entities satisfying the condition will be fetched.
         */
        let fetchRequest = NSFetchRequest<BaseballPlayer>(entityName: "BaseballPlayer")
